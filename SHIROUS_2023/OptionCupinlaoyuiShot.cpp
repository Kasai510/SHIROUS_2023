...
OptionCupinlaoyuiShot::OptionCupinlaoyuiShot(Battle* battle, const std::shared_ptr<class Fish>& master)
...
void OptionCupinlaoyuiShot::update()
{
...
void OptionCupinlaoyuiShot::update_attack()
{
	//敵との当たり判定
...
void OptionCupinlaoyuiShot::set_crash()
{
...
void OptionCupinlaoyuiShot::move()
{
...
void OptionCupinlaoyuiShot::draw()
{
